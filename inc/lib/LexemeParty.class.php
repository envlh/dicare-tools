    ...
    public function display() {
        ...
        if ($this->languages_direction == 'rows') {
            ...
            foreach ($this->concepts as $concept) {
                ...
                if (!empty($this->concepts_meta[$concept]->label)) {
                    echo '<br /><a href="https://www.wikidata.org/w/index.php?search='.rawurlencode($this->concepts_meta[$concept]->label).'&amp;title=Special%3ASearch&amp;profile=advanced&amp;fulltext=1&amp;ns146=1"><img src="'.SITE_STATIC_DIR.'img/search.png" title="Search in Wikidata Lexemes" class="logo" /></a> <a href="https://'.$this->language_display.'.wiktionary.org/w/index.php?title=Special%3ASearch&amp;search='.rawurlencode($this->concepts_meta[$concept]->label).'"><img src="'.SITE_STATIC_DIR.'img/logo-wiktionary.png" title="Search in Wiktionary" class="logo" /></a> <a href="'.str_replace('"', '%22', 'https://query.wikidata.org/embed.html#%23defaultView%3ABarChart%0ASELECT %3Flemma_str (COUNT(DISTINCT %3FlanguageLabel) AS %3Fcount) (GROUP_CONCAT(DISTINCT %3FlanguageLabel %3B separator%3D"%2C ") AS %3Flanguages) {%0A%20 SELECT %3Flemma_str %3FlanguageLabel {%0A%20%20%20 %3Flexeme dct%3Alanguage %3Flanguage %3B wikibase%3Alemma %3Flemma %3B ontolex%3Asense %3Fsense .%0A%20%20%20 %3Fsense wdt%3AP5137 wd%3A'.$concept.' .%0A%20%20%20 BIND (STR(%3Flemma) AS %3Flemma_str) .%0A%20%20%20 SERVICE wikibase%3Alabel { bd%3AserviceParam wikibase%3Alanguage "[AUTO_LANGUAGE]%2Cen" }%0A%20 }%0A}%0AGROUP BY %3Flemma_str%0AORDER BY DESC(%3Fcount) %3Flemma_str').'"><img src="'.SITE_STATIC_DIR.'img/famfamfam/chart_bar.png" title="Bar chart" class="logo" /></a>';
                }
                echo '</th>';
            }
