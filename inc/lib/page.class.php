...
class page {
    ...
    public static function displayMenu() {
        switch (self::$menu) {
            case 'lexemes':
                echo '<div id="menu"><a href="'.SITE_DIR.LEXEMES_SITE_DIR.'challenge.php">Lexemes Challenge</a> | <a href="'.SITE_DIR.LEXEMES_SITE_DIR.'challenges-rankings.php">Challenges Rankings</a> | <a href="'.SITE_DIR.LEXEMES_SITE_DIR.'challenges-archive.php">Challenges Archive</a> | <a href="'.SITE_DIR.LEXEMES_SITE_DIR.'party.php">Lexemes Party</a></div>';
            break;
            case 'noms':
