...
<p><label for="property">Property that links senses to the concepts returned by the preceding SPARQL query:</label><br /><input type="text" id="property" name="property" style="width: 100px;" value="'.htmlentities($party->property_form).'" /></p>
